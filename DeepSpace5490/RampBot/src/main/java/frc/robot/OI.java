...
public class OI {
	...
	public OI() {
		...
		//button4.whileHeld(new LiftManualMove(1,0.5));
		//button6.whileHeld(new LiftManualMove(-1,0.5));
		//button11.whileHeld(new Climb());
		//button12.whileHeld(new ClimbBack());
		//button11.whileHeld(new LiftManualMove(-1,0.5));
		//button12.whileHeld(new LiftManualMove(1,0.5));
		// TODO for testing purposes
		button3.whileHeld(new TransferToBack());
		button5.whileHeld(new TransferToForward());
